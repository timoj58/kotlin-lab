...
class RouteFactoryTest {
    ...
    private val interchangeFactory = InterchangeFactory(lineFactory)
    private val routeFactory = RouteFactory(interchangeFactory)
    ...
    fun `calculate route including circle line Bayswater to Stratford `() {  //very slow but tests circle.
        ...
        routeFactory.getAvailableRoutes(Pair("37", "528"))
        val enquiry = routeFactory.getAvailableRoutes(Pair("37", "528"))

        Assertions.assertThat(enquiry.routes.size)
            .isEqualTo(5614) //better tests at some point. will change as more routes added.

        //test if the circle interchange is present.
        Assertions.assertThat(enquiry.routes).contains(
            listOf(
                Pair("Circle:37", "Circle:418"),
                Pair("Circle:418", "Circle:183"),
                Pair("Circle:183", "Circle:24"),
                Pair("Jubilee:24", "Jubilee:63"),
                Pair("Jubilee:63", "Jubilee:235"),
                Pair("Jubilee:235", "Jubilee:629"),
                Pair("Jubilee:629", "Jubilee:598"),
                Pair("Jubilee:598", "Jubilee:509"),
                Pair("Jubilee:509", "Jubilee:345"),
                Pair("Jubilee:345", "Jubilee:50"),
                Pair("Jubilee:50", "Jubilee:93"),
                Pair("Jubilee:93", "Jubilee:94"),
                Pair("Jubilee:94", "Jubilee:396"),
                Pair("Jubilee:396", "Jubilee:95"),
                Pair("Jubilee:95", "Jubilee:615"),
    ...
    fun `calculate routes from Stratford to Canary Wharf `() {
        val enquiry = routeFactory.getAvailableRoutes(Pair("528", "94"))

        Assertions.assertThat(enquiry.routes).contains(
            listOf(
                Pair("Jubilee:528", "Jubilee:615"),
                Pair("Jubilee:615", "Jubilee:95"),
                Pair("Jubilee:95", "Jubilee:396"),
                Pair("Jubilee:396", "Jubilee:94")
            ),
            listOf(
                Pair("DLR:528", "DLR:438"),
                Pair("DLR:438", "DLR:67"),
                Pair("DLR:67", "DLR:163"),
                Pair("DLR:163", "DLR:330"),
                Pair("DLR:330", "DLR:12"),
                Pair("DLR:12", "DLR:435"),
                Pair("DLR:435", "DLR:619"),
                Pair("DLR:619", "DLR:94")
            ),
        )
    }
    ...
    fun `calculate routes for Beckton to Canary Wharf`() {
        val enquiry = routeFactory.getAvailableRoutes(Pair("41", "94"))

        Assertions.assertThat(enquiry.routes).contains(
            listOf(
                Pair("DLR:41", "DLR:219"),
                Pair("DLR:219", "DLR:153"),
                Pair("DLR:153", "DLR:42"),
                Pair("DLR:42", "DLR:466"),
                Pair("DLR:466", "DLR:437"),
                Pair("DLR:437", "DLR:151"),
                Pair("DLR:151", "DLR:468"),
                Pair("DLR:468", "DLR:95"),
                Pair("Jubilee:95", "Jubilee:396"),
                Pair("Jubilee:396", "Jubilee:94")
            ),
